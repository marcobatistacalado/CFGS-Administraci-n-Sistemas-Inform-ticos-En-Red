...
DNI_ENTRENADOR VARCHAR2(9),--LONGITUD =9 Y QUE LA ULTIMA LETRA SEA EN
MAYUSCULAS
Nombre_Equipo VARCHAR2(20) UNIQUE,--ESTE DATO TIENE QUE SER ÚNICO
Nacionalidad VARCHAR2(20),
Num_Jugadores NUMBER(1),--QUE EL NUMERO DE JUGADOORES SEA >=5 Y <8
...
TELEFONO VARCHAR2(9),
ROLL CHAR(1),--T,J,M,A,S
SUPERVISOR VARCHAR2(20),
ALIAS VARCHAR2(10),--QUE EMPIECE Y ACABE POR COMILLAS SIMPLES
...
TIPO VARCHAR2(10),
DESCRIPCION VARCHAR2(200),--EMPIECE POR MAYUSCULAS , ACABE POR UN PUNTO Y
QUE TENGA MAS DE 20 PALABRAS. SUBSTR(DESCRIPCION,-1)='.'
...
FUNCION VARCHAR2(20),--QUE LAS OPCIONES SEAN LIMPIEZA
,AUDIOVISUALES,SONIDO,CAMARA,VEDEDORES COMIDA,SEGURIDAD
...
DIRECCION VARCHAR2(40),-- QUE EMPIECE POR C DE CALLE O AV DE AVENIDA O ALGO
MAS +'/'+ EL NOMBRE DE LA CALLE
PAIS VARCHAR2(20),
...
HORARIO date,
CLASIFICACION NUMBER(2) NOT NULL,--QUE NO HAYA NINGUNA POSICION A 0
DURACION number,--QUE DURACION SEA >15MINS
...
PUNTUACION NUMBER (3),
NUM_RONDAS NUMBER (1),-- QUE NO SUPEREN LAS 5 RONDAS
