...
<body>
    ...
    <div class="container">
        ...
        <?php
            ...
            if (!isset($_POST['cod']) || !isset($_POST['mail']) )
                die("No has entrado desde el formulario correcto");
        
            $cod = test_input($_POST['cod']);
            $mail = test_input($_POST['mail']);
            if ($cod == "" || $mail == ""){
                die ("No has introducido nada");
            }
            if (strlen($cod)!='6'){
                die ("Código no tiene 6 caracteres");
            }
            if (strpos($mail,'@') == false){
                die ("el correo no contiene @");
            }
            ...
            try {
                $sql = "SELECT * FROM anuncios WHERE codigo='$cod'";
                ...
                ?>
                    ...
                    <input type="hidden" value="<?php echo $cod?>" name="codigo">
